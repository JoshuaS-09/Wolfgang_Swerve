...
public class SwerveModule {
  ...
  public CANCoder m_turningEncoder;
  private final CANCoderConfiguration m_cancoderConfig;
  ...
  public SwerveModule(
    ...
    m_cancoderConfig.sensorCoefficient = 2 * Math.PI / kEncoderResolution;
    m_turningEncoder.configAllSettings(m_cancoderConfig);
